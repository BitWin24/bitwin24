Contributing to MAG Core
============================

The MAG Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MAG Core project, and is not to be
confused with overall MAG Network Protocol consensus changes.

Whether a pull request is merged into MAG Core rests with the project merge
...
Patches that change MAG consensus rules are considerably more involved than
...
Where a patch set proposes to change the MAG consensus, it must have been
...
The project leader is the release manager for each MAG Core release.
