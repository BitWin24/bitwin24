...
*Setup instructions for a gitian build of MAG using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the MAG
...
- [Building MAG](#building-bitwin24)
...
To build MAG (for Linux, OSX and Windows) just follow the steps under 'perform
