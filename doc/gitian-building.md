...
*Setup instructions for a gitian build of BITWIN24 using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the BITWIN24
...
- [Building BITWIN24](#building-bitwin24)
...
Clone the git repositories for bitwin24 and gitian and then checkout the bitwin24 version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/bitwin24-crypto/bitwin24.git
cd bitwin24
...
Follow the instructions in [doc/release-process.md](release-process.md) in the bitwin24 repository
...
To build BITWIN24 (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the bitwin24 repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/bitwin24/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/bitwin24-crypto/bitwin24
...
For example:
```bash
URL=https://github.com/crowning-/bitwin24.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit bitwin24=${COMMIT} --url bitwin24=${URL} ../bitwin24/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit bitwin24=${COMMIT} --url bitwin24=${URL} ../bitwin24/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit bitwin24=${COMMIT} --url bitwin24=${URL} ../bitwin24/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/bitwin24-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/bitwin24-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/bitwin24-build.assert
```
...
[bitwin24/gitian.sigs](https://github.com/bitwin24-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
