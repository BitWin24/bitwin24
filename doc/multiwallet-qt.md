...
In order to support loading of multiple wallets in bitwin24-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitwin24.cpp.
...
Changes to bitwin24.cpp
----------------------
bitwin24.cpp is the entry point into bitwin24-qt, and as such, will require some minor modifications to provide hooks for
