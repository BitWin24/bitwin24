...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/BitWin24/BITWIN24/blob/master/doc/translation_process.md#synchronising-translations).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/BitWin24/gitian.sigs.git
    git clone https://github.com/BitWin24/bitwin24-detached-sigs.git
...
### Build and sign BITWIN24 Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit bitwin24=v${VERSION} ../bitwin24/contrib/gitian-descriptors/gitian-win.yml
...
- Detached signatures will then be committed to the [bitwin24-detached-sigs](https://github.com/BitWin24/bitwin24-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the BitWin24.io server*.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/BitWin24/BITWIN24/releases/new) with a link to the archived release notes.
