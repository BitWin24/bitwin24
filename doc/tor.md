...
```
./bitwin24d -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=dnetzj6l4cvo2fxy.onion:989
```
...
your bitwin24d's P2P listen port (17172 by default).
```
...
```
./bitwin24d -proxy=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:989 -listen
```
