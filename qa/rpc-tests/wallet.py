...
#   c) node1 mines 32 blocks, so now node 0 has 60001bitwin24, node 1 has 4250bitwin24, node2 has none.
#   d) node0 sends 601 bitwin24 to node2, in two transactions (301 bitwin24, then 300 bitwin24).
