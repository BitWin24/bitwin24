...
/** 
    ...
    ****Note - for BITWIN24 we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of bitwin24 coming in to a transaction
