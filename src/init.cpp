...
std::string LicenseInfo()
{
    return FormatParagraph(strprintf(_("Copyright (C) 2009-%i The Bitcoin Core Developers"), COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf(_("Copyright (C) 2017-2018 The MAC Core Developers"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Copyright (C) 2019 The BITWIN24 Core Developers"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
        ...
        do {
            try {
                ...
                if (GetBoolArg("-reindexmoneysupply", false)) {
                    if (chainActive.Height() > Params().Zerocoin_StartHeight()) {
                        RecalculateZBITWIN24Minted();
                        RecalculateZBITWIN24Spent();
                    }
                    RecalculateBITWIN24Supply(1);
                }
...
//    if (nAnonymizeBWIAmount < 2) nAnonymizeBWIAmount = 2;
    ...
    /* Denominations
       ...
       For example:
       1BITWIN24+1000 == (.1BITWIN24+100)*10
