                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BITWIN24 Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    progressBarLabel->setStyleSheet("QLabel { color : #fff; }");
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BITWIN24 address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitwin24: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BITWIN24 Core"), this);
    aboutAction->setStatusTip(tr("Show information about BITWIN24 Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for BITWIN24"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(networkStyle->getAppIcon(), tr("&Show / Hide"), this);
    toggleHideAction->setStatusTip(tr("Show or hide the main Window"));

    encryptWalletAction = new QAction(QIcon(":/icons/lock_en"), tr("&Encrypt Wallet..."), this);
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BITWIN24 addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BITWIN24 addresses"));
    ...
    openConfEditorAction = new QAction(QIcon(":/icons/editpaste"), tr("Open Wallet &Configuration File"), this);
    openConfEditorAction->setStatusTip(tr("Open configuration file"));
    openMNConfEditorAction = new QAction(QIcon(":/icons/editpaste"), tr("Open &Masternode Configuration File"), this);
    openMNConfEditorAction->setStatusTip(tr("Open Masternode configuration file"));
    showBackupsAction = new QAction(QIcon(":/icons/key"), tr("Show Automatic &Backups"), this);
    ...
    openAction->setStatusTip(tr("Open a BITWIN24: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/edit"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BITWIN24 Core help message to get a list with possible BITWIN24 command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BITWIN24 Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BITWIN24 network", "", count));
}
...
{
    QString strTitle = tr("BITWIN24 Core"); // default title
