                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MAG Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MAG address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MAG Core"), this);
    aboutAction->setStatusTip(tr("Show information about MAG Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for MAG"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MAG addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MAG addresses"));
    ...
    openAction->setStatusTip(tr("Open a MAG: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the MAG Core help message to get a list with possible MAG command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MAG Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MAG network", "", count));
}
...
{
    QString strTitle = tr("MAG Core"); // default title
