...
{
    QString CSS = "body {font-size:12px; color:#f8f6f6; bgcolor:#02273B; background-color: #011C2A}\n a, span { font-family: monospace; }\n span.addr {color:#788a89; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #02273B;}\n td.d0 {font-weight: bold; color:#f8f6f6;}\n h2, h3 { white-space:nowrap; color:#fff;}\n a { color:#F8AF1F; text-decoration:none; }\n a.nav {color:#fff;}\n";
